...
// if(record.status==0){
// 	return 	<Link key={1} style={{color:"green"}} title={record.statusDescription}>非常健康</Link>
// }else if(record.status==1){
// 	return 	<Link key={2} style={{color:'#DB7093'}} title={record.statusDescription}>一般</Link>
// }else if(record.status==2){
// 	return 	<Link key={3} style={{color:'blue'}} title={record.statusDescription}>健康</Link>
// }else if(record.status==3){
// 	return 	<Link key={4} style={{color:'#DB7093'}} title={record.statusDescription}>很不健康</Link>
// }else if(record.status==4){
// 	return 	<Link key={5} style={{color:'red'}} title={record.statusDescription}>非常不健康</Link>
// }



// record.prodNoList.map((val,index)=>{
// 	if(val==='BAE'){
// 		return 	<Link key={index}>账户安全险一分钱&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='FAE'){
// 		return 	<Link key={index}>冬季暖心意外险(春节红包)&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='FAF'){
// 		return 	<Link key={index}>春节返乡在家安全保(春节红包)&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='EBT'){
// 		return 	<Link key={index}>防骗险&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='EBU'){
// 		return 	<Link key={index}>饿了么(平台责任险)&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='EBV'){
// 		return 	<Link key={index}>河狸家(职业责任险)&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='FAG'){
// 		return 	<Link key={index}>饿了么(骑手意外伤害险)&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='BAI'){
// 		return 	<Link key={index}>饿了么(非机动车盗抢险)&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='EBX'){
// 		return 	<Link key={index}>食品安全险&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}else if(val==='EBW'){
// 		return 	<Link key={index}>银行卡安全险&nbsp;&nbsp;&nbsp;&nbsp;</Link>
// 	}
// })	